...
export default function Dashboard(props) {
    const {compras, proveedores} = usePage().props;
                ...
                <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg">
                    <div className="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                        <div className="flex items-center justify-between mb-6">
                            ...
                            {/*<Link
                                className="text-yellow-500 hover:text-white border border-yellow-500 hover:bg-yellow-500 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:border-yellow-500 dark:text-yellow-500 dark:hover:text-white dark:hover:bg-yellow-500"
                                href={route("cotizaciones.index")}><FontAwesomeIcon icon={faFilePdf}
                                                                                    className="md:mr-2 mr-0"/>Cotización</Link>*/}
                        ...
                        <div
                            ...
                            <table className="rounded-lg border-collapse lg:table-auto w-full">
                                ...
                                <tr className="border-b border-gray-300 dark:border-gray-700 dark:bg-gray-900 bg-gray-200">
                                    ...
                                    <th
                                        className={`uppercase border-r border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 ${compras.length === 0 ? "px-4" : "px-8"} py-3`}
                                    >
                                        Total
                                    </th>
                                    <th
                                    ...
                                    <th
                                        className={`uppercase text-center border-b border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 ${compras.length === 0 ? "px-4" : "px-8"} py-3`}
                                    >
                                        Opciones
                                    </th>
                                </tr>
                                ...
                                <tbody>
                                {data.map(({
                                               id, codigo, proveedor_id, fecha, total, monto_pagado, estado,
                                           }, index) => {
                                    const proveedor = proveedores.find((c) => c.id === proveedor_id);
                                    ...
                                    >
                                        ...
                                        <td className="border-r text-center dark:border-gray-700 border-gray-300 px-4 py-2 text-gray-900 dark:text-gray-100">
                                            {formatCurrency(monto_pagado)}
                                        </td>
                                        <td className={`border-r text-center dark:border-gray-700 border-gray-300 px-4 py-2 ${estado === 'Cancelado' ? 'text-green-500' : 'text-red-500'}`}>
                                            {estado}
                                        </td>
