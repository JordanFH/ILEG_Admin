...
export default function Dashboard(props) {
    const {proveedores} = usePage().props;
    ...
    const destroy = async (id) => {
        try {
            ...
            const updated = data.filter((proveedor) => proveedor.id !== id);
            setData(updated);
        } catch (error) {
            // Manejar el error
            console.error(error);
                        ...
                        <div
                            ...
                            <table className="rounded-lg border-collapse lg:table-auto w-full">
                                ...
                                <tr className="border-b border-gray-300 dark:border-gray-700 dark:bg-gray-900 bg-gray-200">
                                    ...
                                    <th className={`uppercase text-center border-b border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 ${proveedores.length === 0 ? 'px-4' : 'px-8'} py-3`}>
                                        Opciones
                                    </th>
                                </tr>
                                </thead>
                                <tbody>
                                {data.map(({
                                               id, nombreEmpresa, nombreContacto, direccion, ruc, telefono, email
                                           }, index) => (<tr
                                ...
                                >
                                    ...
                                    <td className="text-center dark:border-gray-700 border-gray-300 px-4 py-2">
                                        <Link
                                            ...
                                            type="button"
                                            href={route("proveedores.edit", id)}
                                        >
                                            <FontAwesomeIcon
                                                icon={faPencilAlt}
                                            />
                                        ...
                                        <button
                                            onClick={() => {
                                                ...
                                                setItemSeleccionado(nombreEmpresa);
                                                openModal();
                                            }}
                                            tabIndex="-1"
                                            type="button"
