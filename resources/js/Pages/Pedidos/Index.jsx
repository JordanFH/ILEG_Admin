...
export default function Dashboard(props) {
    const {pedidos, clientes} = usePage().props;
                        ...
                        <div
                            ...
                            <table className="rounded-lg border-collapse lg:table-auto w-full">
                                ...
                                <tr className="border-b border-gray-300 dark:border-gray-700 dark:bg-gray-900 bg-gray-200">
                                    ...
                                    <th
                                        className={`uppercase border-r border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 ${pedidos.length === 0 ? "px-4" : "px-8"} py-3`}
                                    >
                                        Total
                                    </th>
                                    <th
                                    ...
                                    <th
                                        className={`uppercase text-center border-b border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 ${pedidos.length === 0 ? "px-4" : "px-8"} py-3`}
                                    >
                                        Opciones
                                    </th>
                                </tr>
                                ...
                                <tbody>
                                {data.map(({
                                               id, codigo, cliente_id, fecha, total, monto_pagado, estado,
                                           }, index) => {
