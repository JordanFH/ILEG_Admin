...
export default function Dashboard(props) {
    const {pedido, clientes, productos, servicios, detalle_pedidos,user} = usePage().props;
    ...
    function handlePedidoSubmit(e) {
        e.preventDefault();
        putPedido(route("pedidos.update", pedido.id));
    }
    ...
    useEffect(() => {
        setPedidoData(prevData => ({
            ...
            total: totalGeneral + roundToTwo(totalGeneral * 0.18)
        }));
    }, [totalGeneral]);
    const {
        ...
        fecha: pedido.fecha || fechaString,
    ...
    async function handleDetallePedidoSubmit(e) {
        ...
        try{
            ...
            const response = await axios.post(route("detalles.storeDetalle", { id: pedido.id }), detallePedidoData);
            ...
            if(newDetalle === "el item_id es null"){
                ...
                setPedidoData(prevData => ({
                    ...
                    impuestos: pedidoData.impuestos + roundToTwo(newDetalleM.monto/1.18 * 0.18),
    ...
    useEffect(() => {
        ...
        const nuevoIGV = roundToTwo(nuevoSubtotal * 0.18);
        console.log("nuevoIGvvv", roundToTwo(nuevoSubtotal * 0.18))
        const descuentoCalculado = pedidoData.subtotal * roundToTwo(pedidoData.descuento / 100)
    ...
    }, [pedidoData.subtotal, pedidoData.impuestos, pedidoData.descuento, pedidoData.monto_pagado, pedidoData.total]);
                            ...
                            <div className="lg:flex block">
                                ...
                                <div className="flex flex-col w-full">
                                    <div className="mb-4">
                                        ...
                                        <CurrencyInput
                                            placeholder="0.00"
                                            value={pedidoData.total- pedidoData.impuestos + pedidoData.descuentoCalculado}
                                            onChange={(e) => {
                                                const inputValue = e.target.value;
