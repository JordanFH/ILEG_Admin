...
export default function Dashboard(props) {
    const {servicios, categorias} = usePage().props;
    ...
    const destroy = async (id) => {
        try {
            ...
            const updated = data.filter((servicio) => servicio.id !== id);
            setData(updated);
        } catch (error) {
            // Manejar el error
            console.error(error);
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <td className="text-center dark:border-gray-700 border-gray-300 px-4 py-2">
                                                        <Link
                                                            tabIndex="1"
                                                            className="w-15 sm:w-auto m-1 2xl:px-6 px-4 py-2 text-sm text-white bg-blue-500 hover:bg-blue-600 rounded"
                                                            type="button"
                                                            href={route(
                                                                "servicios.edit",
                                                                id
                                                        ...
                                                        >
                                                            ...
                                                            />
                                                            <span className="ml-0 2xl:ml-2 hidden 2xl:inline-block">
                                                                    Editar
                                                                </span>
                                                        </Link>
                                                        <button
