...
export default function Dashboard(props) {
    ...
    const destroy = async (id) => {
        try {
            ...
            const updated = data.filter((producto) => producto.id !== id);
            setData(updated);
        } catch (error) {
            // Manejar el error
            console.error(error);
                                        ...
                                        (
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <td className={`border-r text-center dark:border-gray-700 border-gray-300 px-4 py-2 ${stock === 0 ? 'text-red-500' : 'text-gray-900 dark:text-gray-100'}`}>
                                                        {stock}
                                                    </td>
